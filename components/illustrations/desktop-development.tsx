...
import { PATHS } from "./paths/desktop-development.paths";
      ...
      <g id="Frame 1">
        ...
        >
          ...
          <motion.path
            ...
            d={PATHS.imac.monitorInsideCorners}
            fill="black"
            animate={
              isInView
                ? {
          ...
          >
            <g id="background_2">
              <path
                id="Vector 3"
                d={PATHS.backgrounds.background1.vector3}
                fill={`url(#${id}-paint1)`}
              />
              <path
                id="Vector 2"
                d={PATHS.backgrounds.background1.vector2}
                fill={`url(#${id}-paint2)`}
              />
              <path
                id="Vector 1"
                d={PATHS.backgrounds.background1.vector1}
                fill={`url(#${id}-paint3)`}
              />
            </g>
            <motion.g
        ...
        >
          ...
          >
            <g id="background_4">
              <path
                id="Vector 3_2"
                d={PATHS.backgrounds.background2.vector3}
                fill={`url(#${id}-paint6)`}
              />
              <path
                id="Vector 2_2"
                d={PATHS.backgrounds.background2.vector2}
                fill={`url(#${id}-paint7)`}
              />
              <path
                id="Vector 1_2"
                d={PATHS.backgrounds.background2.vector1}
                fill={`url(#${id}-paint8)`}
              />
            </g>
            <motion.g
